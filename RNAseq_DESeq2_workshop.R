...
library("Rsamtools")
# indicate that these are bam files using BamFileList function from Rsamtools package
...
## Effects of transformations on the variance ##s
...
# overall similarity between samples: Which samples are similar to each other, 
...
# plot, specify rownames and colnames for clarity - note bringing infrom the summarized experiment
...
plt
ggsave("./default_PCA.pdf", height=4, width=6.5)
